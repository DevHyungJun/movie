  ...
  return (
    <div className='header-container'>
      ...
      <div className='input-box'>
        <img src={process.env.PUBLIC_URL + '/img/search-icon.png'} onClick={showInput} alt='search-icon' />
    ...
    <>
      ...
      <div className='home-screen'>
        ...
        <div className='flex-container'>
          <div className="left arrow" onClick={scrollLeft}><img src={process.env.PUBLIC_URL + '/img/left.png'} alt="next_left" /></div>
          ...
          <div className="right arrow" onClick={scrollRight}><img src={process.env.PUBLIC_URL + '/img/right.png'} alt="next_left" /></div>
        </div>
      </div>
    </>
  )
